<template>
      ...
      <ul class="navbar-nav">
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            <li v-for="member in team" :key="member.id"> <RouterLink active-class="active"  :to="{name: 'team' , params:{id: member.id}}" class="dropdown-item"> {{ member.name }} </RouterLink></li>
  ...
  <div class="wrapper z-3">
    ...
    <transition
    appear
    @before-enter="footerBeforeEnter"
    @enter="footerEnter"
    >
